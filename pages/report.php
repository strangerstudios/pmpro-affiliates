	...
	*/
	...
	if($report)
	{
		...
		<div class="pmpro_content_message">
			...
			echo sprintf(
				__( 'Add the string %1s (first parameter) or %2s (second or later parameter) to any link to this site. If you would like to track against specific campaigns, you can add the parameter %3s or %4s to your URL. Some example links are included below.', 'pmpro-affiliates' ),
