...
- [ ] The issue still exists against the latest `dev` branch of Paid Memberships Pro on Github (this is **not** the same version as the one available on our website [ADD ON NAME](https://www.paidmembershipspro.com/add-ons/pmpro-lightweight-affiliate-tracking/)
